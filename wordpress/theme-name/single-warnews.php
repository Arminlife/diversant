...
$important_post = get_posts(
    [
        ...
        'meta_query'    => [
            [
                'key'   => 'wpcf-main-photo-description',
                'value' => '1'
            ]
        ],
    ]
...
$params = [ 'param1' => get_field('field_tag_new_template') ];

$is_tag = get_field('full_wight');
...
if($is_tag) : ?>
    ...
    <div class="single">
        <div class="related-post-block">
            <?php get_template_part( 'parts/related-posts', null, $params ); ?>
        </div>
    </div>
	...
	<div class="row">
		...
		<div class="col-lg-4 pr-lg-5">
			<aside class="single-post-sidebar">
                <?php get_sidebar('single-warnews')?>
			</aside>
		</div><!--//col-->
	</div><!--//row-->
</div>

			...
			<div class="footer__col">
				...
				<div class="footer__info">
					<?php if (!empty($copyright_year)) : ?>
						<div class="footer__copyright">© <?php echo esc_html($copyright_year); ?> Slidstvo.Info</div>
					<?php endif; ?>

					<?php if (!empty($privacy_link)) : ?>
						<a class="footer__link" href="<?php echo esc_url($privacy_link); ?>">Політика конфіденційності</a>
					<?php endif; ?>
				</div>
			</div>

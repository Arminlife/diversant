...
<div class="container list">
    ...
    <?php if ( have_posts() ) : ?>
        ...
        <?php
        $kupyansk_posted = false;
        ?>

        <?php while ( have_posts() ) : the_post(); ?>

            <!-- Kupyansk story goes if it hasn't been posted yet -->
            <?php
            if ( get_the_date( 'U' ) < get_the_date( 'U', $kupyansk_post ) and !$kupyansk_posted ) {
                $kupyansk_posted    = true;
                ?>
                <article id="post-<?php echo $kupyansk_id; ?>" class="row post-<?php echo $kupyansk_id; ?> status-publish hentry">
                    ...
                    <div class="col-lg-3 col-md-12 p-lg-0 pb-sm-4">
                        ...
                        <a href="<?php the_permalink( $kupyansk_id ); ?>" title="<?php the_title_attribute( [ 'post' => $kupyansk_post ] ); ?>" >
                            ...
                            <?php echo get_the_post_thumbnail( $kupyansk_id, 'thumbnails-vertical' ); ?>
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <a href="<?php the_permalink( $kupyansk_id ); ?>" title="<?php echo get_the_title( $kupyansk_id ); ?>">
                            <h2><?php echo get_the_title( $kupyansk_id ); ?></h2>
                        </a>

                        <p class="excerpt"><?php echo get_the_excerpt( $kupyansk_id ); ?></p>

                        <p class="post_date"><?php echo get_the_date( '', $kupyansk_id ); ?></p>

                    </div>

                </article>
            <?php } ?>
            <!-- End of Kupyansk story -->

<?php
global $post;
$related_posts = CC_Functions::getAdditionalMaterialsPravosyllya( $post->ID );
...
<?php if ( ! empty( $related_posts ) && is_array( $related_posts ) ) : ?>
	...
	<div class="related-posts pravosyllia">

		<div class="container-fluid">

			<h2 class="pravosyllia-related-heading"><?php esc_html_e( 'Stories from behind the grid', 'slidstvo-info-theme' ); ?></h2>

<?php
	...
	$search = get_field('header_search_link', 'option');
...
<header class="header js-header">
	<div class="header__top section_in section_in--border_mod">
		...
		<div class="header_search js-header-search">
			<a class="header_search__trigger js-header-search-trigger" href="<?php echo !empty($search['url']) ? esc_url($search['url']) : '#'; ?>">
